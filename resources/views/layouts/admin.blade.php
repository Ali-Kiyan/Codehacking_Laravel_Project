        ...
        <ul class="nav navbar-top-links navbar-right">
            ...
            <li class="dropdown">
                <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                    <img src="{{Auth::user()->photo ? Auth::user()->photo->file : '/images/unknown.png'}}" alt="" style="border-radius: 50px;height: 18px;">      {{ Auth::user()->name }}  <i class="fa fa-caret-down"></i>

                </a>
                <ul class="dropdown-menu dropdown-user">
                    <li><a href="{{route('admin.users.edit', Auth::user()->id)}}"><i class="fa fa-user fa-fw"></i> User Profile</a>
                    </li>
                    <li><a href="{{route('admin.posts.index')}}"><i class="fa fa-envelope fa-fw"></i> All Post</a>
                    </li>
                    <li class="divider"></li>
